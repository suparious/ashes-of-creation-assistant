...
<#
.SYNOPSIS
    Build and push MyAshes.ai Backend Docker image to Docker Hub

.DESCRIPTION
    Builds the MyAshes.ai FastAPI backend application Docker image and optionally pushes to Docker Hub
